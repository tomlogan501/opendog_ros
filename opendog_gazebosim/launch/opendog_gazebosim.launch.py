...
pkg_opendog_gazebo = FindPackageShare(package='opendog_gazebosim').find('opendog_gazebosim')

# Set the path to the world file
world_file_name = 'contact.world'
world_path = os.path.join(pkg_opendog_gazebo, 'worlds', world_file_name)
# world_path = os.path.join(pkg_opendog_gazebo, 'worlds', 'contact.world')

# world_path = "/usr/share/gazebo-11/worlds/friction_demo.world"


# configure opendog teleop
...
def generate_launch_description():
 ...
 # Set the path to this package.
  ...
  opendog_gz_joint_ctrl_node = Node(
