...
class LegWalkingController(Node):
    ...
    def __init__(self):
        ...
        self.timer = self.create_timer(0.05, self.timer_callback)  # Shorter timer period for smoother motion
    ...
    def publish_trajectory(self, positions):
        ...
        point.time_from_start.nanosec = int(0.05 * 1e9)  # 0.05 seconds execution time (matching timer period)
