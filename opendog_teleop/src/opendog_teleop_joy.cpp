...
#include "opendog_msgs/msg/joy_ctrl_cmds.hpp"
// #include "opendog_msgs/msg/ctrl_variables.hpp"

#include "opendog_definitions.hpp"
// #include "opendog_ctrl_variables.hpp"
...
auto cmd = opendog_msgs::msg::JoyCtrlCmds();
...
class PublishingSubscriber : public rclcpp::Node
{
  public: 
    ...
    : Node("opendog_teleop_gamepad_node")
    {
      subscription_ = this->create_subscription<sensor_msgs::msg::Joy>(
        "joy", 12, std::bind(&PublishingSubscriber::topic_callback, this, _1));

      publisher_ = this->create_publisher<opendog_msgs::msg::JoyCtrlCmds>("opendog_joy_ctrl_cmd",40);
    }
  ...
  private:
    ...
    rclcpp::Publisher<opendog_msgs::msg::JoyCtrlCmds>::SharedPtr publisher_;
};
