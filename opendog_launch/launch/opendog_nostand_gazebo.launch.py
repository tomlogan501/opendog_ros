...
pkg_opendog_gazebo = 'opendog_nostand_description'
robot_description_subpath = 'urdf/opendog_nostand.urdf.xacro'
xacro_file = os.path.join(get_package_share_directory(pkg_opendog_gazebo),robot_description_subpath)
robot_description_raw = xacro.process_file(xacro_file).toxml()

#configure gazebo
pkg_gazebo_ros = FindPackageShare(package='gazebo_ros').find('gazebo_ros') 
pkg_opendog_gazebo = FindPackageShare(package='opendog_nostand_description').find('opendog_nostand_description')
