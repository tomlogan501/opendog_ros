...
def generate_launch_description():
    ...
    br_leg_test_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["br_leg_test_controller", "-c", "/controller_manager"],
    )
    ...
    nodes = [
        ...
        TimerAction(
            period=5.0,
            actions=[br_leg_test_controller_spawner]
        ),
    ]
